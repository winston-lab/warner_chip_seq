...
bigwigCompare -b1 deeptools/averaged/${cond}_${IP}_averaged_si.bw -b2 deeptools/averaged/${cond}_input_averaged_si.bw -o deeptools/averaged/${cond}_${IP}_averaged_si_ratio.bw \
	--operation ratio \
	-bs 20 \
	-p max
