...
for df in replicates:
    ...
    plt.savefig('Flag_'+names[counter]+'.png')
    plt.show();
    counter+=1
...
for df in replicates:
    ...
    plt.legend(loc='upper left')
    plt.title(names[counter])
    plt.savefig('8WG16_'+names[counter]+'.png')
    plt.show();
    counter+=1
...
for df in replicates:
    ...
    plt.legend(loc='upper left')
    plt.title(names[counter])
    plt.savefig('Flag_v_8WG16_'+names[counter]+'.png')
    plt.show();
    counter+=1
...
plt.ylim(-0.5,13)
plt.title('Flag rep3')
plt.savefig('Flag_rep3_scatter.png')
plt.show();
...
plt.ylim(-0.5,25)
plt.title('Rpb1 rep3')
plt.savefig('8WG16_rep3_scatter.png')
plt.show();
...
plt.ylabel('Spt6Δ2-238')
plt.ylim(0,1.25)
plt.title('Flag/Rpb1 rep3')
plt.savefig('Flag_v_8WG16_rep3_scatter.png')
plt.show();
